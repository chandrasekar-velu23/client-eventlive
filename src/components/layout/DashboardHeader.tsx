...
export default function DashboardHeader({ setIsOpen, collapsed, setCollapsed }: DashboardHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 shrink-0 items-center justify-between gap-x-6 border-b border-brand-accent bg-bg-primary/80 backdrop-blur-md px-4 shadow-sm lg:px-8 transition-all relative">
      <div className="flex items-center gap-4">
        ...
        {/* Navigation History Controls - Desktop - Moved Left */}
        <div className="hidden lg:flex items-center gap-2 bg-brand-surface/50 p-1 rounded-full border border-brand-accent/10">
          <button
            onClick={() => navigate(-1)}
