          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-bold text-brand-dark mb-1">Brand Accent Color</label>
                  <div className="flex items-center gap-3">
                    <input type="color" value={formData.brandAccentColor} onChange={e => updateFormData({ brandAccentColor: e.target.value })} className="h-10 w-14 p-1 rounded cursor-pointer border border-brand-accent/20" />
                  </div>
                </div>
              </div>
            </div>
